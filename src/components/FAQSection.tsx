    ...
    >
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16" id="faq-header-wrapper">
          <div className="flex items-center justify-center gap-3 mb-4" id="faq-tagline-wrapper">
            <div className="w-12 h-[2px] bg-brand-orange"></div>
            <span 
              className="text-brand-orange text-[11px] leading-[28px] tracking-[1.65px] uppercase font-bold"
              id="faq-tagline"
            >
              Got Questions?
            </span>
